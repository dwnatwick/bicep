...
import example_custom_deployment_script_basic from '../../../docs/examples/custom/deployment-script-basic/main.bicep'
...
export const examples = {
  ...
  'custom/deployment-script-basic': example_custom_deployment_script_basic,
}